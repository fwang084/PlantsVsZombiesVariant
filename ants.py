...
class ThrowerAnt(Ant):
    ...
    food_cost=3
    min_range= 0
    max_range= 99999 #ants that do not override this will essentially have no max range
    ...
    def nearest_bee(self, hive):
        ...
        place=self.place
        count=0
        while place!=hive and count<=self.max_range: 
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        place, armor, damage =self.place, self.armor, self.damage
        Ant.reduce_armor(self, amount)
        if amount>=armor:
            copy_bees=place.bees[:]
            for b in copy_bees:
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        ...
        for b in self.place.bees:
            if b.armor<=self.damage:
                copy_bees.remove(b)
        for b in copy_bees:
            b.reduce_armor(self.damage)
        self.place.bees=copy_bees
        # END Problem 7
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        ...
        if self.contained_ant==None and other.is_container==False:
            ...
            return other.contained_ant==None and self.is_container==False
        return False
        # END Problem 9
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.real_queen:
            ...
            while place!=None:
                if place.ant!=None:
                    if place.ant.damage_doubled==False:
                        place.ant.damage=place.ant.damage*2
                        place.ant.damage_doubled=True
                    if place.ant.is_container and place.ant.contained_ant!=None and place.ant.contained_ant.damage_doubled==False:
                        place.ant.contained_ant.damage=place.ant.contained_ant.damage*2
